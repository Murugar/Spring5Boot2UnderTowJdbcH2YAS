...
public class MainAppTests {
    ...
    public void testFindId() {
        ...
        Assert.assertEquals("Test2", student.getFirstName());
        Assert.assertEquals("Test2", student.getLastName());
    }

    @Test
    public void testFindIdsByFirstName() {
        List<Map<String, Object>> ids = studentJdbcRepository.findIdByFirstName("Test1");
    ...
    public void testUpdate() {
        ...
        Assert.assertEquals("Test1", student.getFirstName());
